...
epsilon_vals_list = [0.7, 0.71, 0.72, 0.73, 0.74, 0.75, 0.76, 0.77, 0.78, 0.79, 0.8, 0.81, 0.82,
                     0.83, 0.84, 0.85, 0.86, 0.87, 0.88, 0.89, 0.9, 0.91, 0.92, 0.93, 0.94, 0.95, 0.96, 0.97, 0.98, 0.99]

learning_rate_list = [0.8, 0.81, 0.82, 0.83, 0.84, 0.85, 0.86, 0.87,
                      0.88, 0.89, 0.9, 0.91, 0.92, 0.93, 0.94, 0.95, 0.96, 0.97, 0.98, 0.99]

decay_factor_list = [0.90, 0.91, 0.92, 0.93,
                     0.94, 0.95, 0.96, 0.97, 0.98, 0.99]


def execute_file():
    dir = os.getcwd()
    file_loc = dir + '/runner.sh'
    os.system(file_loc)
