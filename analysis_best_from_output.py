...
def analyse_output_files():
        ...
        if os.path.isdir(dir_path):
            ...
            for file in os.listdir(file_path):
                if file == 'analysis.log':
                    ...
                    if file_read_dict['Best Similarity Percentage'] > maxm_sim_per:
                        maxm_sim_per = file_read_dict['Best Similarity Percentage']
                        best_file_sim_per = full_file_path
                    if file_read_dict['Worst Similarity Percentage'] > minm_sim_per:
                        minm_sim_per = file_read_dict['Worst Similarity Percentage']
                        worst_file_sim_per = full_file_path
    ...
    lines_to_write.append(
        f'# The best file in terms of edge similarity in this scenario is {file_read_dict["Best Similarity Percentage"]}\n# And the worst case file is {file_read_dict["Worst Similarity Percentage"]}.\n')
    lines_to_write.append(
        f'# The best file of this scenario is: {best_file_loc}\n')
    ...
    lines_to_write.append(
        f'# The best file in terms of edge similarity in this scenario is {file_read_dict["Best Similarity Percentage"]}\n# And the worst case file is {file_read_dict["Worst Similarity Percentage"]}.\n')
    lines_to_write.append(
        f'# The worst file of this scenario is: {worst_file_loc}\n')
    lines_to_write.append(
        f'############################################################################################\n')
