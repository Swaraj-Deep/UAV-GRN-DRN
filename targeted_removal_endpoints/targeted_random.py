...
def plot_graph(UAV_G, UAV_location, file_name, plot_label, x_label, y_label, flag):
    ...
    """
    global radius_UAV, N, cell_size, unit_mul
    plt.clf()
    ...
    if flag:
        ...
        for edge in UAV_G.edges:
            ...
            edge_y = [y1, y2]
            if legend_flag:
                plt.plot(edge_x, edge_y, color='black', label='Common Edges')
                legend_flag = False
            else:
...
def run(i, file_name_baseline, file_name_main):
    ...
    plot_graph(UAV_G, UAV_location, f'EMST_random_{file_num}_(0).png',
    ...
    plot_graph(UAV_G, UAV_location, f'Proposed_random_{file_num}.png',
    ...
    plot_graph(UAV_G, UAV_location, f'EMST_random_{file_num}_(1).png',
    ...
    plot_graph(UAV_G, UAV_location, f'EMST_random_{file_num}_(1.5).png',
...
def simulate_plot_making(file_name_baseline, file_name_main):
    ...
    Parameter: None, file_name_baseline -> file name for the baseline output, file_name_main -> file name for the main output\n\n
...
def init(file_name_baseline, file_name_main):
    """
    Function: init\n
    Parameters: file_name_baseline -> file name for the baseline output, file_name_main -> file name for the main output\n
